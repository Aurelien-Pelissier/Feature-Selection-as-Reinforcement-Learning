...
class Params
{
    ...
    //Builders & Destroyers
    Params(const bool &m_MA, const double &m_q, const int &m_k, const double &m_ce, const double &m_c, const double &m_cl, const double &m_b, const std::vector< std::vector<float> > &m_L);
    ~Params();
